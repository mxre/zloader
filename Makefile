...
%.efi: $(OBJS)
	...
	$(OBJCOPY) --add-section .osrel=loader/os-release --add-section .cmdline=loader/cmdline --add-section .linux=loader/Image.zst --add-section .initrd=loader/initrd.img $@.stub $@
	$(VMA_FIXER) $@
#	install -D -t build $@
